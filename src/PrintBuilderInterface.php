...
interface PrintBuilderInterface {
   ...
   */
  public function deliverPrintable(array $entities, PrintEngineInterface $print_engine, $force_download = FALSE, $use_default_css = TRUE, $theme = 'entity_print');
   ...
   */
  public function printHtml(EntityInterface $entity, $use_default_css = TRUE, $optimize_css = TRUE, $template = 'entity_print');
