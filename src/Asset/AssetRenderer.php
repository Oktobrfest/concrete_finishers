...
namespace Drupal\concrete_finishers\Asset;
...
class AssetRenderer implements AssetRendererInterface {
   ...
   *   The CSS renderer.
   * @param \Drupal\concrete_finishers\Asset\AssetCollector $asset_collector
   *   The asset collector.
   */
  public function __construct(AssetResolverInterface $asset_resolver, AssetCollectionRendererInterface $css_renderer, AssetCollector $asset_collector) {
